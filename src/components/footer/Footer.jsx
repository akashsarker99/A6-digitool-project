            ...
            <footer className='bg-[#101727] '>
               <section className='container mx-auto flex flex-col md:flex-row 
                  ...
                  <div className='grid grid-cols-3 gap-8 md:gap-30 text-center md:text-left'>
                    ...
                    <div><h2 className='text-lg sm:text-xl font-semibold text-white mb-2'>Company</h2>
                     <ul className='space-y-2'>
                        <li>About</li>
                        <li>Blog</li>
                        <li>Carriers</li>
                    ...
                    <div><h2 className='text-lg sm:text-xl font-semibold text-white mb-2'>Resources</h2>
                     <ul className='space-y-2'>
                        <li>Documentation</li>
                        <li>Help Center</li>
                        <li>Community</li>
