...
const PricingCard = ({card}) => {
    ...
    return (
        <div>
            <div className={`card ${card.tagType === 'popular' ? 'bg-linear-to-r from-[#067D68] to-[#50D5B7] text-white ': 'bg-[#F2F2F2]'} border shadow border-gray-300 rounded-2xl h-full flex flex-col relative transition-all ease-in-out duration-400 hover:-translate-y-2`}>
